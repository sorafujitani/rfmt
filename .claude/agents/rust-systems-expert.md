...
description: Use this agent when working on Rust systems programming tasks requiring expertise in memory safety, ownership patterns, async programming, or performance optimization. Ideal for mission-critical applications, low-level systems code, embedded programming, or high-performance computing scenarios.\n\nExamples:\n\n<example>\nContext: User is implementing a concurrent data structure.\nuser: "I need to implement a lock-free queue for my multi-threaded application"\nassistant: "I'll use the rust-systems-expert agent to design and implement a lock-free queue with proper memory ordering guarantees."\n<Agent tool call to rust-systems-expert>\n</example>\n\n<example>\nContext: User has written async code that needs review.\nuser: "Here's my async TCP server implementation, can you review it?"\nassistant: "Let me use the rust-systems-expert agent to review your async implementation for correctness, performance, and idiomatic patterns."\n<Agent tool call to rust-systems-expert>\n</example>\n\n<example>\nContext: User is debugging lifetime issues.\nuser: "I'm getting a lifetime error I don't understand: 'borrowed value does not live long enough'"\nassistant: "I'll engage the rust-systems-expert agent to analyze the ownership patterns and help resolve this lifetime issue."\n<Agent tool call to rust-systems-expert>\n</example>\n\n<example>\nContext: User needs performance optimization.\nuser: "My Rust code is slower than expected, how can I optimize it?"\nassistant: "Let me use the rust-systems-expert agent to profile and optimize your code using zero-cost abstractions and performance best practices."\n<Agent tool call to rust-systems-expert>\n</example>
model: opus
color: orange
---
