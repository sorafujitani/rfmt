...
impl KenshinLogger {
    ...
    pub fn init() {
        ...
        let debug_mode = std::env::var("DEBUG").is_ok()
            || std::env::var("KENSHIN_DEBUG").is_ok()
            || std::env::var("RUST_LOG").is_ok();

        let level = std::env::var("KENSHIN_LOG")
            .ok()
...
mod tests {
    ...
    fn test_logger_creation() {
        let logger = KenshinLogger::new(LevelFilter::Info);
    ...
    fn test_logger_level_filtering() {
        let logger = KenshinLogger::new(LevelFilter::Warn);
    ...
    fn test_logger_output() {
        ...
        let logger = KenshinLogger::new(LevelFilter::Info).with_output(Box::new(writer));
